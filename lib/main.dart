...
String FB_BANNER_ADD_ID = "IMG_16_9_APP_INSTALL#2312433698835503_2964944860251047";
...
Widget openlikinent(String string) {
  ...
  return Center(
    child: Text("Link is opening in browser"),
  );
}
...
Widget searchAndReturnStaticFile(String string) {
  ...
  if (file.contains("pageOne")) {
    return Stack(
      children: <Widget>[
        Positioned(
          top: 00, bottom: 50,left : 0,right : 0,
          child: pageOne,
        ),
        Positioned(
          bottom: 00,left : 0,right : 0,
          child:  ((_isFBBannerAdLoaded)? Flexible(
            child: Align(
              alignment: Alignment(0, 1.0),
              child: bannerFB,
  ...
  for (Map i in jsonResponse) {
    if (CustomBodyModel
      ...
      commentWidgets.add(new Padding(
        ...
        child: Text(CustomBodyModel
            .fromJson(i)
            .body),
      ));
    } else if (CustomBodyModel
        .fromJson(i)
        .type
        .contains("img")) {
      commentWidgets.add(new Padding(
        ...
        child:
        Image.network(CustomBodyModel
            .fromJson(i)
            .body, fit: BoxFit.fill),
      ));
    }
  }
  if (answer != null) {
   ...
   if ((CLICK_COUNTER % SHOW_AD_AFTER == 0)) {
     ...
     //  showThisToast("it should show now fb");
       ...
       if (await interstitialAd.isLoaded) {
        ...
        // showThisToast("No instrestatial add in available");
     }
   }
